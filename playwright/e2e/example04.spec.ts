...
test.describe('Example 04 - Select Auto-Width', () => {
  test('every select drop parent should have different width', async ({ page }) => {
    ...
    assertDropWidth(page, '[data-test=select1].ms-parent', 85);
    ...
    assertDropWidth(page, 'div[data-test=select2].ms-parent', 119);
    ...
    assertDropWidth(page, 'div[data-test=select3].ms-parent', 309);
