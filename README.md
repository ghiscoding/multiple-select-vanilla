...
[![npm bundle size](https://img.shields.io/bundlephobia/minzip/multiple-select-vanilla?style=flat-square&color=success&label=gzip)](https://bundlephobia.com/result?p=multiple-select-vanilla)
